...
<html lang="en">
    ...
    <body class=" page-404-3">
        ...
        <!--[if lt IE 9]>
        <script src="admin_/global/plugins/respond.min.js"></script>
        <script src="admin_/global/plugins/excanvas.min.js"></script> 
        <script src="admin_/global/plugins/ie8.fix.min.js"></script> 
        <![endif]-->
        <!-- BEGIN CORE PLUGINS -->
