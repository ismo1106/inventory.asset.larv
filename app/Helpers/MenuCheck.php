...
class MenuCheck {
    ...
    public static function __getMenuHeader()
    {
        return $menus = Menu::where('header', 0)->orderBy('order', 'asc')->get();
    }

    public static function __getMenuChild()
    {
        return $menus = Menu::where('header', '<>', 0)->orderBy('order', 'asc')->get();
    }

    public static function __optFA()
    {
        return $icons = array(
            "fa-glass" => "f000",
            "fa-music" => "f001",
